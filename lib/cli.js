...
exports.exec = function(options, done) {
  ...
  if (exports.args.l) {
    if (typeof exports.args.l.value === 'string') {
      ...
      lintOptions = JSON.parse(util.stripComments(json));
    }
    platoOptions.jshint = { globals : lintOptions.globals || {} };
    delete lintOptions.globals;
    platoOptions.jshint.options = lintOptions;

  } else if (exports.args.e) {
    json = fs.readFileSync(exports.args.e.value).toString();
    lintOptions = JSON.parse(util.stripComments(json));
    platoOptions.eslint = lintOptions;
  }
